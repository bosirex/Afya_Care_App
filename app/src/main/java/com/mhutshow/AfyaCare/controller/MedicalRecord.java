...
import com.mhutshow.AfyaCare.model.Common.Common;
import com.mhutshow.AfyaCare.model.adapter.ConsultationFragmentAdapter;
...
public class MedicalRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Med_report = findViewById(R.id.Med_report);
        Med_report.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(MedicalRecord.this, MedicationReportActivity.class);
                startActivity(k);
            }
        });
        ...
        Log.d(TAG, "onCreate medical records activity: started");
        getIncomingIntent();
    ...
    private void openPatientFile(){
        Intent intent = new Intent(this, ActivityFile.class);
